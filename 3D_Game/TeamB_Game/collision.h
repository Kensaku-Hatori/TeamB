...
bool collisionobbface(OBB obb, OBB obb1, D3DXVECTOR3 Pos,D3DXVECTOR3 VecMove);								// OBBとOBBの当たり判定
D3DXVECTOR3 collisionobbfacedot(OBB obb, OBB obb1, D3DXVECTOR3 Pos, D3DXVECTOR3 Pos1);
